package com.xjz.ssmshiro.core.feature.orm.mybatis;

import com.xjz.ssmshiro.core.feature.orm.dialect.Dialect;
import com.xjz.ssmshiro.core.feature.orm.dialect.DialectFactory;
...
public class PaginationStatementHandlerInterceptor implements Interceptor {
    ...
    public Object intercept(Invocation invocation) throws Throwable {
        ...
        // 设置物理分页语句
        metaStatementHandler.setValue("delegate.boundSql.sql", dialect.getLitmitString(originalSql, page.getOffset(), page.getLimit()));
        // 屏蔽mybatis原有分页
