package com.xjz.ssmshiro.core.util;
...
public class CookieUtils {
     ...
     * @return 值
     */
    private static String getCookie(HttpServletRequest request, HttpServletResponse response, String name, boolean isRemoved) {
        String value = null;
